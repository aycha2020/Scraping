...
os.makedirs(r"C:\Users\user\Desktop\avito\logs", exist_ok=True)
...
df = pd.read_csv(r"C:\Users\user\Desktop\scraping\cleaned_data.csv")
...
df_fact = df[["titre_id", "ville_id", "prix", "surface", "chambres", "salle_de_bain", "prix_par_m2"]]
